...
- Discuss Gravify out in the real world.
...
At the core of any Python library is its code, and Gravify is no
...
1. [Fork and clone][git-fork] the bsoyka/gravify repository to make a copy
...
[issues]: https://github.com/bsoyka/gravify/issues

[issues-new]: https://github.com/bsoyka/gravify/issues/new
